...
RUN cd /tmp && \
    wget --no-check-certificate http://mirror.linux-ia64.org/apache/atlas/${VERSION}/apache-atlas-${VERSION}-sources.tar.gz && \
    mkdir /tmp/atlas-src && \
...
COPY atlas_config.py.patch /opt/apache-atlas-${VERSION}/bin
